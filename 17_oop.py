...
# Oop is an important Python topic.
...
# What is OOP? is part of the foundation of Oop.
...
# Classes is part of the foundation of Oop.
# Read the comments first, then run the small example.
...
# Objects is part of the foundation of Oop.
# Read the comments first, then run the small example.
...
students = [Student("Rahul", 21), Student("Rohan", 22)]
...
# This section focuses on attributes.
...
# This section focuses on methods.
# Use it to understand how the concept appears
# inside real programs.
...
# This section focuses on __init__ constructor.
# Use it to understand how the concept appears
# inside real programs.
...
# In real projects, Oop should be used with clean names,
...
# self helps connect Oop to practical Python.
...
# Practical Examples helps connect Oop to practical Python.
# Focus on the idea first, then practice the syntax.
...
# Q1. What is Oop?
# Answer:
# Oop is a Python topic used to write better programs.
#
# Q2. Why is Oop useful?
# Answer:
...
# - Oop is part of practical Python.
