...
# Regex is an important Python topic.
...
# What is Regex? is part of the foundation of Regex.
...
# re Module is part of the foundation of Regex.
# Read the comments first, then run the small example.
...
# search() is part of the foundation of Regex.
# Read the comments first, then run the small example.
...
def explain_regex():
    return "Regex is important in Python."
...
# This section focuses on findall().
# Use it to understand how the concept appears
# inside real programs.
...
# In real projects, Regex should be used with clean names,
...
# PART 3
# ========================================================
# PYTHON REGEX - PRACTICE & REVISION
# ========================================================
...
# Character Classes helps connect Regex to practical Python.
...
# Practical Examples helps connect Regex to practical Python.
# Focus on the idea first, then practice the syntax.
...
# Q1. What is Regex?
# Answer:
# Regex is a Python topic used to write better programs.
#
# Q2. Why is Regex useful?
# Answer:
...
# - Regex is part of practical Python.
