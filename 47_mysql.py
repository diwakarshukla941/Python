...
# Mysql is an important Python topic.
...
# What is MySQL? is part of the foundation of Mysql.
...
# Drivers is part of the foundation of Mysql.
# Read the comments first, then run the small example.
...
# Connection is part of the foundation of Mysql.
# Read the comments first, then run the small example.
...
def explain_mysql():
    return "Mysql is important in Python."
...
# In real projects, Mysql should be used with clean names,
...
# PART 3
# ========================================================
# PYTHON MYSQL - PRACTICE & REVISION
# ========================================================
...
# Transactions helps connect Mysql to practical Python.
...
# Best Practices helps connect Mysql to practical Python.
# Focus on the idea first, then practice the syntax.
...
# Q1. What is Mysql?
# Answer:
# Mysql is a Python topic used to write better programs.
#
# Q2. Why is Mysql useful?
# Answer:
...
# - Mysql is part of practical Python.
