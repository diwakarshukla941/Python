...
# Performance is an important Python topic.
...
# What is Performance? is part of the foundation of Performance.
...
# Measuring Time is part of the foundation of Performance.
# Read the comments first, then run the small example.
...
# timeit is part of the foundation of Performance.
# Read the comments first, then run the small example.
...
def explain_performance():
    return "Performance is important in Python."

print(explain_performance())
...
# PART 2
# ========================================================
# PYTHON PERFORMANCE - DEEPER CONCEPTS
# ========================================================
...
# This section focuses on profiling.
...
# This section focuses on caching.
# Use it to understand how the concept appears
# inside real programs.
...
# In real projects, Performance should be used with clean names,
...
# PART 3
# ========================================================
# PYTHON PERFORMANCE - PRACTICE & REVISION
# ========================================================
...
# Data Structures helps connect Performance to practical Python.
...
# Best Practices helps connect Performance to practical Python.
# Focus on the idea first, then practice the syntax.
...
# Q1. What is Performance?
# Answer:
# Performance is a Python topic used to write better programs.
#
# Q2. Why is Performance useful?
# Answer:
...
# - Performance is part of practical Python.
